...
// @name:zh-CN         ACT.谷歌.MO.NCR-强力版
// @description        Google Search Redirect to .com domian, set language to en-US once (useful when search through address bar).
// @description:zh-CN  谷歌搜索重定向到 .com 域，设置一次语言为 en-US（从地址栏直接搜索时很有用）。
// @author             ACTCD
// @version            20220326.1
...
// @updateURL          https://raw.githubusercontent.com/ACTCD/Userscripts/main/userjs/ACT.Google.DM.NCR-Force.user.js
// @downloadURL        https://raw.githubusercontent.com/ACTCD/Userscripts/main/userjs/ACT.Google.DM.NCR-Force.user.js
...
(function () {
    ...
    if (url.hostname == "www.google.com") { // Avoid redirection loops
        if (url.pathname != "/search") return;
        if (url.searchParams.get("gws_rd") == "cr" && url.searchParams.get("client") != "safari") return;
    }
